...
public class FakePhotoCategoryAdapter extends ListAdapter<PhotoCategory, FakePhotoCategoryAdapter.ViewHolder> {
    ...
    public FakePhotoCategoryAdapter(Context context) {
        super(DIFF_CALLBACK);
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        FakePhotoCategoryAdapter.ViewHolder viewHolder = new FakePhotoCategoryAdapter.ViewHolder(contactView);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        FakePhotosAdapter photosAdapter = new FakePhotosAdapter(mContext);
